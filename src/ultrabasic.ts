        ...
        switch(char){
            case "{":
                ...
                if(typeof cur !== "string"){
                    throw new ReferenceError("You can't reference anything else than strings");
                }
            ...
            case "/":
                ...
                const charNotToParse = from[i];
                if(!charNotToParse){
                    toRet.push("/");
                }
                else
                    toRet.push(charNotToParse);    
                break;       
            default:
                toRet.push(char);
        }
...
export {uptimeVar, logSystemError, pseudoStreamWriteAble, pseudoStreamWriteAbleListenable, streamWrapper, templateReplacer}
